...
use app\common\components\base\tests\unit\controllers\BaseServiceControllerTest;

/**
 * < Console > PascalCaseServiceTest
 *
 * @cli ./vendor/bin/codecept run app/console/tests/unit/controllers/items/ItemServiceControllerTest
 *
